...
export const translations = {
  zh: {
    ...
    indonesiaClarificationNote: '📞 移工請查詢地點並致電領事館緊急熱線',
    newsItems: [
  ...
  en: {
    ...
    indonesiaClarificationNote: '📞 Migrant Workers are requested to check the venue in addition to calling the consulate on its Emergency number',
    newsItems: [
  ...
  tl: {
    ...
    indonesiaClarificationNote: '📞 Hinihiling sa mga Migrant Workers na suriin ang venue bilang karagdagan sa pagtawag sa consulate sa Emergency number nito',
    newsItems: [
  ...
  id: {
    ...
    indonesiaClarificationNote: '📞 Pekerja Migran diminta untuk memeriksa tempat selain menelepon konsulat pada nomor Darurat',
    newsItems: [
