...
export const translations = {
  zh: {
    ...
    newsTicker: '💔 至少128人於大埔火災中罹難，包括7名印尼籍家庭傭工 | 🇵🇭 菲律賓領事館消息：63名菲籍人士安全、1人受傷、1人失蹤、28人待核實',
    filterCategories: '篩選類別',
    allCategories: '全部類別',
    categoryEmergency: '緊急救援',
    categoryMigrantSupport: '外傭支援',
    categoryAnimalWelfare: '寵物救援',
    categoryVolunteer: '義工組織',
    categoryShelter: '住宿服務',
  ...
  en: {
    ...
    newsTicker: '💔 At least 128 confirmed dead in Tai Po fire, including 7 migrant domestic workers from Indonesia | 🇵🇭 Philippine Consulate update: 63 Filipinos safe, 1 injured, 1 missing, 28 for verification',
    filterCategories: 'Filter Categories',
    allCategories: 'All Categories',
    categoryEmergency: 'Emergency Relief',
    categoryMigrantSupport: 'Migrant Worker Support',
    categoryAnimalWelfare: 'Animal Welfare',
  ...
  tl: {
    ...
    languageNotification: 'Awtomatiko naming pinili ang wika batay sa iyong browser settings. Maaari mong palitan ang wika anumang oras gamit ang language selector sa kanang sulok sa itaas.',
    newsTicker: '💔 Kahit 128 katao ang napatay sa sunog sa Tai Po, kabilang ang 7 domestic workers mula Indonesia | 🇵🇭 Philippine Consulate: 63 Pilipino ligtas, 1 nasugatan, 1 nawawala, 28 para sa verification',
    filterCategories: 'Filter ng Kategorya',
    allCategories: 'Lahat ng Kategorya',
    categoryEmergency: 'Emergency Relief',
    categoryMigrantSupport: 'Suporta para sa Domestic Workers',
    categoryAnimalWelfare: 'Animal Welfare',
    categoryVolunteer: 'Volunteer Groups',
    categoryShelter: 'Shelter Services',
  ...
  id: {
    ...
    newsTicker: '💔 Setidaknya 128 orang tewas dalam kebakaran Tai Po, termasuk 7 pekerja rumah tangga migran dari Indonesia | 🇵🇭 Konsulat Filipina: 63 warga Filipina aman, 1 terluka, 1 hilang, 28 untuk verifikasi',
    filterCategories: 'Filter Kategori',
    allCategories: 'Semua Kategori',
    categoryEmergency: 'Bantuan Darurat',
    categoryMigrantSupport: 'Dukungan Pekerja Rumah Tangga',
    categoryAnimalWelfare: 'Kesejahteraan Hewan',
    categoryVolunteer: 'Kelompok Relawan',
    categoryShelter: 'Layanan Penampungan',
    categorySupplies: 'Persediaan & Donasi',
