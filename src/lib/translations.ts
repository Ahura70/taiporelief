...
export const translations = {
  zh: {
    ...
    casualtiesDeaths: '確認死亡：156人',
    casualtiesInjured: '受傷：79人',
    casualtiesAwaiting: '29具遺體待辨認，30人仍下落不明',
    casualtiesSearches: '8具遺骸於12月1日處理；搜索持續進行；90宗親屬程序已完成',
    financialAssistanceTitle: '財政及福利援助',
    financialEmergency: '緊急現金津貼：已向1,900+登記家庭中的1,861戶發放每戶$10,000',
    financialPayments: '撫恤金：每個遇難者家庭$200,000團結金 + $50,000喪葬支援（已處理18個）；每戶$50,000生活津貼（已處理20個）',
    financialAdditionalSubsidies: '額外援助：受傷津貼（$50K–$100K）、學生/勞工/外傭津貼（每人$20K）',
    financialSwd: '社會福利署：已聯絡1,450個家庭；3,300名居民已登記每戶支援。如需協助請致電 182 183',
    supportFundTitle: '宏福苑支援基金',
    supportFundTotal: '總額：$16億（$13億捐款 + $3億政府撥款），用於重建及長期援助',
    supportFundPurpose: '→ 用於重建家園及長期支援',
    housingTitle: '住宿支援',
    housingHostels: '945人入住青年旅舍/酒店；1,470人入住過渡性房屋；2個庇護所開放',
    housingTransitional: '行政長官李家超視察協和上悅河（60+家庭）',
    housingShelters: '政務司司長陳國基視察博愛江夏圍村',
    housingVisits: '對快速發放津貼及物資等援助措施表示讚賞',
    socialHealthTitle: '社會及健康支援',
    socialHealthContacted: '社會福利署：已聯絡1,450個家庭',
    socialHealthRegistered: '3,300名居民已登記每戶支援',
    socialHealthHotline: '如需協助請致電 182 183',
    donationsTitle: '物資捐贈',
    donationsPlatform: '網上平台（www.taipodonation.hk）：470+登記，涵蓋食品、衣物、家電',
    donationsDistribution: '物資即將分發',
    medicalTitle: '醫療服務',
    ...
    buildingSafetyInspections: '8座大樓共1,700+單位已檢查；未發現即時危險；計劃進行核心測試',
    buildingSafetyNetsInspection: '宏福苑及4個居屋屋苑的防護網已抽樣檢查；不合規將被拆除/起訴',
    buildingSafetyBdChecks: '屋宇署：已檢查359座建築物；300座已抽樣檢查防護網（結果即將公布）；無新阻塞',
    buildingSafetyLdInspections: '勞工處：已檢查61個工地；發出53項警告、13項通知書、2宗火警安全檢控',
    investigationsTitle: '調查',
    investigationsArrests: '拘捕：共13人（新增10人），涉嫌誤殺，來自建築/工程公司；可能還有更多拘捕行動',
    funeralTitle: '喪葬安排',
    funeralSupport: '食環署專職人員協助每個喪親家庭。可透過您指派的社工或富山公眾殮房櫃台聯絡。',
  ...
  en: {
    ...
    casualtiesDeaths: 'Deceased: 156',
    casualtiesInjured: 'Injured: 79',
    casualtiesAwaiting: '29 bodies awaiting identification with 30 individuals unaccounted for',
    casualtiesSearches: '8 remains handled Dec 1; searches ongoing; 90 next-of-kin procedures done',
    financialAssistanceTitle: 'Financial and Welfare Support',
    financialEmergency: 'Emergency subsidy: $10K to 1,861 of 1,900+ registered households',
    financialPayments: 'Payments: $200K solidarity + $50K funeral per deceased family (18 processed); $50K living allowance per household (20 processed)',
    financialAdditionalSubsidies: 'Additional subsidies: Injury ($50K–$100K), student/worker/helper ($20K each)',
    financialSwd: 'SWD: Contacted 1,450 households; 3,300 residents registered for per-household support. Call 182 183 if needed',
    supportFundTitle: 'Support Fund',
    supportFundTotal: '$1.6B total: $1.3B donations + $300M govt for rebuilding and long-term aid',
    supportFundPurpose: '→ For rebuilding homes and long-term support',
    housingTitle: 'Accommodation Support',
    housingHostels: '945 in hostels/hotels; 1,470 in transitional units; 2 shelters open',
    housingTransitional: 'CE John Lee visited CONCORDIA Sheung Yue River (60+ families)',
    housingShelters: 'CS Chan Kwok-ki visited Pok Oi Kong Ha Wai Village',
    housingVisits: 'Praised quick aid like subsidies and supplies',
    socialHealthTitle: 'Social & Health Support',
    socialHealthContacted: 'SWD: Contacted 1,450 households',
    socialHealthRegistered: '3,300 residents registered for per-household support',
    socialHealthHotline: 'Call 182 183 if needed',
    donationsTitle: 'Relief Supplies and Donations',
    donationsPlatform: 'Platform (www.taipodonation.hk): 470+ registrations for food, clothing, appliances',
    donationsDistribution: 'Items to be distributed',
    ...
    identityDocsReplacements: 'Immigration: 1,090 replacements',
    ...
    buildingSafetyTitle: 'Inspections',
    buildingSafetyInspections: '1,700+ units in 8 buildings inspected; no imminent dangers; core tests planned',
    buildingSafetyNetsInspection: 'Protective nets sampled at Wang Fuk Court + 4 HOS courts; non-compliance leads to removals/prosecutions',
    buildingSafetyBdChecks: 'BD: 359 buildings checked; 300 with nets sampled (results soon); no new blockages',
    buildingSafetyLdInspections: 'LD: 61 sites inspected; 53 warnings, 13 notices, 2 prosecutions for fire safety',
    investigationsTitle: 'Investigations',
    investigationsArrests: 'Arrests: 13 total (10 new) for manslaughter from construction/engineering firms; more possible',
    funeralTitle: 'Funeral Arrangements',
    funeralSupport: 'Dedicated FEHD staff assisting each bereaved family. Contact via your assigned social worker or Fu Shan Public Mortuary counter.',
  ...
  tl: {
    ...
    casualtiesDeaths: 'Namatay: 156',
    casualtiesInjured: 'Nasugatan: 79',
    casualtiesAwaiting: '29 katawan naghihintay ng pagkilala, 30 indibidwal hindi pa nakikita',
    casualtiesSearches: '8 labi na-handle Dis 1; patuloy ang paghahanap; 90 proseso ng next-of-kin tapos na',
    financialAssistanceTitle: 'Tulong Pinansyal at Welfare',
    financialEmergency: 'Emergency subsidy: $10K sa 1,861 ng 1,900+ registered sambahayan',
    financialPayments: 'Bayad: $200K solidarity + $50K funeral kada pamilya ng namatay (18 proseso); $50K living allowance kada sambahayan (20 proseso)',
    financialAdditionalSubsidies: 'Karagdagang subsidies: Pinsala ($50K–$100K), estudyante/manggagawa/helper ($20K bawat isa)',
    financialSwd: 'SWD: Nakontak ang 1,450 sambahayan; 3,300 residente nag-rehistro para sa per-household support. Tumawag sa 182 183 kung kailangan',
    supportFundTitle: 'Support Fund',
    supportFundTotal: '$1.6B kabuuan: $1.3B donasyon + $300M gobyerno para sa pagtatayo muli at pangmatagalang tulong',
    supportFundPurpose: '→ Para sa pagtatayo muli ng mga tahanan at pangmatagalang suporta',
    housingTitle: 'Suporta sa Tirahan',
    housingHostels: '945 sa hostels/hotels; 1,470 sa transitional units; 2 shelters bukas',
    housingTransitional: 'CE John Lee bumisita sa CONCORDIA Sheung Yue River (60+ pamilya)',
    housingShelters: 'CS Chan Kwok-ki bumisita sa Pok Oi Kong Ha Wai Village',
    housingVisits: 'Pinuri ang mabilis na tulong tulad ng subsidies at supplies',
    socialHealthTitle: 'Social & Health Support',
    socialHealthContacted: 'SWD: Nakontak ang 1,450 sambahayan',
    socialHealthRegistered: '3,300 residente nag-rehistro para sa per-household support',
    socialHealthHotline: 'Tumawag sa 182 183 kung kailangan',
    donationsTitle: 'Relief Supplies at Donasyon',
    donationsPlatform: 'Platform (www.taipodonation.hk): 470+ rehistrasyon para sa pagkain, damit, appliances',
    donationsDistribution: 'Ipapamahagi ang mga gamit',
    ...
    identityDocsTitle: 'Identity Documents',
    identityDocsReplacements: 'Immigration: 1,090 pagpapalit',
    ...
    buildingSafetyTitle: 'Inspections',
    buildingSafetyInspections: '1,700+ units sa 8 gusali na-inspect; walang agarang panganib; plano ang core tests',
    buildingSafetyNetsInspection: 'Protective nets na-sample sa Wang Fuk Court + 4 HOS courts; ang hindi sumusunod ay tatanggalin/kakasuhan',
    buildingSafetyBdChecks: 'BD: 359 gusali na-check; 300 may nets na-sample (resulta malapit na); walang bagong blockage',
    buildingSafetyLdInspections: 'LD: 61 sites na-inspect; 53 warnings, 13 notices, 2 prosecutions para sa fire safety',
    investigationsTitle: 'Mga Imbestigasyon',
    investigationsArrests: 'Mga pagkakaaresto: 13 kabuuan (10 bago) para sa manslaughter mula sa construction/engineering firms; posible pang marami',
    funeralTitle: 'Funeral Arrangements',
    funeralSupport: 'Dedicated FEHD staff tumutulong sa bawat bereaved family. Makipag-ugnayan sa iyong assigned social worker o Fu Shan Public Mortuary counter.',
    websiteTitle: 'One-stop Official Website',
    websiteUrl: 'www.taipofire.gov.hk',
  ...
  id: {
    ...
    casualtiesDeaths: 'Meninggal: 156',
    casualtiesInjured: 'Terluka: 79',
    casualtiesAwaiting: '29 jenazah menunggu identifikasi, 30 orang belum ditemukan',
    casualtiesSearches: '8 jenazah ditangani 1 Des; pencarian berlanjut; 90 prosedur kerabat selesai',
    financialAssistanceTitle: 'Dukungan Keuangan dan Kesejahteraan',
    financialEmergency: 'Subsidi darurat: $10K untuk 1,861 dari 1,900+ rumah tangga terdaftar',
    financialPayments: 'Pembayaran: $200K solidaritas + $50K pemakaman per keluarga almarhum (18 diproses); $50K tunjangan hidup per rumah tangga (20 diproses)',
    financialAdditionalSubsidies: 'Subsidi tambahan: Cedera ($50K–$100K), siswa/pekerja/helper ($20K masing-masing)',
    financialSwd: 'SWD: Menghubungi 1,450 rumah tangga; 3,300 penduduk terdaftar untuk dukungan per rumah tangga. Hubungi 182 183 jika perlu',
    supportFundTitle: 'Dana Dukungan',
    supportFundTotal: '$1.6B total: $1.3B donasi + $300M pemerintah untuk pembangunan kembali dan bantuan jangka panjang',
    supportFundPurpose: '→ Untuk membangun kembali rumah dan dukungan jangka panjang',
    housingTitle: 'Dukungan Akomodasi',
    housingHostels: '945 di hostel/hotel; 1,470 di unit transisi; 2 tempat penampungan buka',
    housingTransitional: 'CE John Lee mengunjungi CONCORDIA Sheung Yue River (60+ keluarga)',
    housingShelters: 'CS Chan Kwok-ki mengunjungi Pok Oi Kong Ha Wai Village',
    housingVisits: 'Memuji bantuan cepat seperti subsidi dan persediaan',
    socialHealthTitle: 'Dukungan Sosial & Kesehatan',
    socialHealthContacted: 'SWD: Menghubungi 1,450 rumah tangga',
    socialHealthRegistered: '3,300 penduduk terdaftar untuk dukungan per rumah tangga',
    socialHealthHotline: 'Hubungi 182 183 jika perlu',
    donationsTitle: 'Persediaan dan Donasi Bantuan',
    donationsPlatform: 'Platform (www.taipodonation.hk): 470+ pendaftaran untuk makanan, pakaian, peralatan',
    donationsDistribution: 'Barang akan didistribusikan',
    ...
    identityDocsReplacements: 'Imigrasi: 1,090 penggantian',
    ...
    buildingSafetyTitle: 'Inspeksi',
    buildingSafetyInspections: '1,700+ unit di 8 bangunan diperiksa; tidak ada bahaya segera; tes inti direncanakan',
    buildingSafetyNetsInspection: 'Jaring pelindung disampel di Wang Fuk Court + 4 pengadilan HOS; ketidakpatuhan mengarah pada penghapusan/penuntutan',
    buildingSafetyBdChecks: 'BD: 359 bangunan diperiksa; 300 dengan jaring disampel (hasil segera); tidak ada penyumbatan baru',
    buildingSafetyLdInspections: 'LD: 61 lokasi diperiksa; 53 peringatan, 13 pemberitahuan, 2 penuntutan untuk keselamatan kebakaran',
    investigationsTitle: 'Investigasi',
    investigationsArrests: 'Penangkapan: 13 total (10 baru) untuk pembunuhan tidak sengaja dari perusahaan konstruksi/teknik; kemungkinan lebih banyak',
    funeralTitle: 'Pengaturan Pemakaman',
    funeralSupport: 'Staf FEHD khusus membantu setiap keluarga yang berduka. Hubungi melalui pekerja sosial yang ditugaskan atau konter Fu Shan Public Mortuary.',
