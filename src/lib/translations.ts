...
export const translations = {
  zh: {
    ...
    casualtiesTitle: '傷亡人數（截至11月30日下午4時）',
    ...
    financialSolidarity: '每位遇難者家屬團結金：$200,000',
    financialLiving: '本週起生活津貼：每個受影響家庭$50,000',
    financialFuneral: '喪葬支援：每位遇難者$50,000 + 豁免所有政府骨灰龕費用',
    supportFundTitle: '宏福苑支援基金',
    supportFundTotal: '總額：約$12億（$3億政府種子基金 + $9億公眾捐款，截至11月30日中午）',
    supportFundPurpose: '→ 用於重建家園及長期支援',
    housingTitle: '緊急及過渡性房屋（截至12月1日早上）',
    housingHostels: '683名居民入住青年旅舍/營地或酒店',
    housingTransitional: '1,144名居民遷入過渡性房屋（免費，附浴室、煮食區，歡迎寵物）',
    housingShelters: '2個臨時庇護所仍然開放',
    housingEnquire: '→ 查詢/申請：房屋局熱線 3611 8482',
    housingShuttle: '→ 好屋至港鐵大埔墟站免費穿梭巴士（由12月1日起：首班7:30am，週一至五）',
    socialHealthTitle: '社會及健康支援',
    socialHealthWorker: '「一戶一社工」：約1,300個家庭共3,200名居民已登記',
    socialHealthNotContacted: '→ 尚未聯絡？請致電 182 183',
    socialHealthHealthcare: '地區康健中心及醫管局診所提供醫療、護理、藥物及心理支援（即將推出優先預約）',
    donationsTitle: '物資捐贈',
    donationsPlatform: '網上平台：www.taipodonation.hk（11月30日推出）',
    donationsCollection: '中央收集點：大埔社區中心',
    buildingSafetyTitle: '建築安全及調查',
    buildingSafetyInspections: '9座大樓中7座已完成結構檢查；未發現即時整體危險',
    buildingSafetyRemaining: '餘下2座（宏善樓及宏昌樓）檢查中',
    buildingSafetyRenovation: '宏福苑外牆翻新工程已暫停',
    buildingSafetyTerritoryWide: '全港檢查：發現塑料布/棚架網正在移除；已檢查319座建築物，已發出執法通知',
    funeralTitle: '喪葬安排',
    ...
    closingMessage: '政府及社會各界繼續全天候為所有受影響居民提供支援。',
  ...
  en: {
    ...
    casualtiesTitle: 'Casualties (as of 4pm, 30 Nov)',
    ...
    financialSolidarity: 'Token of solidarity to each deceased victim\'s family: $200,000',
    financialLiving: 'Living allowance starting this week: $50,000 per affected household',
    financialFuneral: 'Funeral support: $50,000 per deceased + waiver of all government columbarium fees',
    supportFundTitle: 'Support Fund for Wang Fuk Court',
    supportFundTotal: 'Total: ≈$1.2 billion ($300M government seed + $900M public donations as of 30 Nov noon)',
    supportFundPurpose: '→ For rebuilding homes and long-term support',
    housingTitle: 'Emergency & Transitional Housing (as of 1 Dec morning)',
    housingHostels: '683 residents in youth hostels/camps or hotels',
    housingTransitional: '1,144 residents moved into transitional housing (free, with bathroom, cooking area, pets welcome)',
    housingShelters: '2 temporary shelters still open',
    housingEnquire: '→ Enquire/apply: Housing Bureau hotline 3611 8482',
    housingShuttle: '→ Free shuttle from Good House to MTR Tai Po Market Station (from 1 Dec: first bus 7:30am Mon–Fri)',
    socialHealthTitle: 'Social & Health Support',
    socialHealthWorker: '"One social worker per household": 3,200 residents from ~1,300 households registered',
    socialHealthNotContacted: '→ Not yet contacted? Call 182 183',
    socialHealthHealthcare: 'District Health Centres & HA clinics providing medical, nursing, medication & psychological support (priority booking coming soon)',
    donationsTitle: 'Donations of Supplies',
    donationsPlatform: 'Online platform: www.taipodonation.hk (launched 30 Nov)',
    donationsCollection: 'Central collection point: Tai Po Community Centre',
    buildingSafetyTitle: 'Building Safety & Investigation',
    buildingSafetyInspections: 'Structural inspections completed for 7 out of 9 blocks; no imminent overall danger found',
    buildingSafetyRemaining: 'Remaining 2 blocks (Wang Sun House & Wang Cheong House) under inspection',
    buildingSafetyRenovation: 'External wall renovation works at Wang Fuk Court suspended',
    buildingSafetyTerritoryWide: 'Territory-wide checks: plastic sheeting/scaffold nets being removed where found; 319 buildings inspected, enforcement actions issued',
    ...
    closingMessage: 'The Government and community continue to work around the clock to support all affected residents.',
  ...
  tl: {
    ...
    casualtiesTitle: 'Bilang ng Nasawi (hanggang 4pm, 30 Nob)',
    ...
    financialSolidarity: 'Token of solidarity para sa pamilya ng bawat namatay: $200,000',
    financialLiving: 'Living allowance magsisimula ngayong linggo: $50,000 bawat apektadong sambahayan',
    financialFuneral: 'Suporta sa libing: $50,000 bawat namatay + waiver ng lahat ng government columbarium fees',
    supportFundTitle: 'Support Fund para sa Wang Fuk Court',
    supportFundTotal: 'Kabuuan: ≈$1.2 bilyon ($300M government seed + $900M public donations hanggang 30 Nob tanghali)',
    supportFundPurpose: '→ Para sa pagtatayo muli ng mga tahanan at pangmatagalang suporta',
    housingTitle: 'Emergency & Transitional Housing (hanggang 1 Dis umaga)',
    housingHostels: '683 residente sa youth hostels/camps o hotels',
    housingTransitional: '1,144 residente lumipat sa transitional housing (libre, may banyo, kusina, welcome ang pets)',
    housingShelters: '2 temporary shelters bukas pa rin',
    housingEnquire: '→ Magtanong/mag-apply: Housing Bureau hotline 3611 8482',
    housingShuttle: '→ Libreng shuttle mula Good House hanggang MTR Tai Po Market Station (mula 1 Dis: unang bus 7:30am Lun–Biy)',
    socialHealthTitle: 'Social & Health Support',
    socialHealthWorker: '"Isang social worker bawat sambahayan": 3,200 residente mula sa ~1,300 sambahayan nagrehistro na',
    socialHealthNotContacted: '→ Hindi pa nakontak? Tumawag sa 182 183',
    socialHealthHealthcare: 'District Health Centres & HA clinics nagbibigay ng medical, nursing, gamot & psychological support (priority booking malapit na)',
    donationsTitle: 'Donasyon ng Supplies',
    donationsPlatform: 'Online platform: www.taipodonation.hk (inilunsad 30 Nob)',
    donationsCollection: 'Central collection point: Tai Po Community Centre',
    buildingSafetyTitle: 'Building Safety & Investigation',
    buildingSafetyInspections: 'Structural inspections natapos na para sa 7 sa 9 blocks; walang nakitang agarang pangkalahatang panganib',
    buildingSafetyRemaining: 'Natitirang 2 blocks (Wang Sun House & Wang Cheong House) pinag-iinspect pa',
    buildingSafetyRenovation: 'External wall renovation works sa Wang Fuk Court suspendido',
    buildingSafetyTerritoryWide: 'Territory-wide checks: plastic sheeting/scaffold nets tinatanggal kung saan nakita; 319 gusali na-inspect, enforcement actions inisyu',
    funeralTitle: 'Funeral Arrangements',
    ...
    closingMessage: 'Ang Gobyerno at komunidad patuloy na nagtatrabaho 24/7 para suportahan ang lahat ng apektadong residente.',
  ...
  id: {
    ...
    casualtiesTitle: 'Korban (hingga 4pm, 30 Nov)',
    ...
    financialSolidarity: 'Token solidaritas untuk keluarga setiap korban meninggal: $200,000',
    financialLiving: 'Tunjangan hidup mulai minggu ini: $50,000 per rumah tangga yang terdampak',
    financialFuneral: 'Dukungan pemakaman: $50,000 per almarhum + pembebasan semua biaya kolumbarium pemerintah',
    supportFundTitle: 'Dana Dukungan untuk Wang Fuk Court',
    supportFundTotal: 'Total: ≈$1.2 miliar ($300M seed pemerintah + $900M donasi publik hingga 30 Nov siang)',
    supportFundPurpose: '→ Untuk membangun kembali rumah dan dukungan jangka panjang',
    housingTitle: 'Perumahan Darurat & Transisi (hingga 1 Des pagi)',
    housingHostels: '683 penduduk di hostel/kamp pemuda atau hotel',
    housingTransitional: '1,144 penduduk pindah ke perumahan transisi (gratis, dengan kamar mandi, area memasak, hewan peliharaan diperbolehkan)',
    housingShelters: '2 tempat penampungan sementara masih buka',
    housingEnquire: '→ Tanyakan/ajukan: Hotline Biro Perumahan 3611 8482',
    housingShuttle: '→ Shuttle gratis dari Good House ke MTR Tai Po Market Station (dari 1 Des: bus pertama 7:30am Sen–Jum)',
    socialHealthTitle: 'Dukungan Sosial & Kesehatan',
    socialHealthWorker: '"Satu pekerja sosial per rumah tangga": 3,200 penduduk dari ~1,300 rumah tangga terdaftar',
    socialHealthNotContacted: '→ Belum dihubungi? Hubungi 182 183',
    socialHealthHealthcare: 'Pusat Kesehatan Distrik & klinik HA menyediakan dukungan medis, perawatan, obat & psikologis (booking prioritas segera hadir)',
    donationsTitle: 'Donasi Persediaan',
    donationsPlatform: 'Platform online: www.taipodonation.hk (diluncurkan 30 Nov)',
    donationsCollection: 'Titik pengumpulan pusat: Tai Po Community Centre',
    buildingSafetyTitle: 'Keselamatan Bangunan & Investigasi',
    buildingSafetyInspections: 'Inspeksi struktural selesai untuk 7 dari 9 blok; tidak ditemukan bahaya keseluruhan yang segera',
    buildingSafetyRemaining: 'Sisa 2 blok (Wang Sun House & Wang Cheong House) sedang dalam inspeksi',
    buildingSafetyRenovation: 'Pekerjaan renovasi dinding eksternal di Wang Fuk Court ditunda',
    buildingSafetyTerritoryWide: 'Pemeriksaan di seluruh wilayah: plastic sheeting/scaffold nets sedang dihapus di mana ditemukan; 319 bangunan diperiksa, tindakan penegakan dikeluarkan',
    ...
    closingMessage: 'Pemerintah dan komunitas terus bekerja sepanjang waktu untuk mendukung semua penduduk yang terdampak.',
